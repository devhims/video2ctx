  ...
  return {
    ...
    trends: vi.fn(async () => ({
      ...
      value: {
        ...
        sampleSize: 1,
        methodologyVersion: '3.0' as const,
        methodology: 'Test methodology.',
        sample: { candidateVideos: 1, enrichedVideos: 1, channels: 1, observedVideos: 0, recentCandidates: 0, recentVideos: 0 },
        window: { days: 14, recentCandidatesSampled: 0, recentVideosEnriched: 0 },
        ...
        videos: [{
          ...
          hashtags: ['#agents'],
          keywords: ['agents'],
          effectiveViewsPerHour: 10,
          velocityRank: 1,
          percentiles: { velocity: 50, freshness: 50, channelPerformance: 50, engagement: 50, acceleration: 50 },
          trendScore: 50,
