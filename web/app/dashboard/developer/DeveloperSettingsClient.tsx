...
export default function DeveloperSettingsClient() {
  ...
  return <main className='developer-page'>
    <header className='developer-header'>
      <div><Link href='/dashboard'>← Dashboard</Link><p className='panel-label'>Developer access</p><h1>Personal API keys</h1><p>Use permanent keys for your own scripts and integrations. They act as you for product data and workspace operations, and metered requests spend credits from {user.email}.</p></div>
