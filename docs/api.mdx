...
The hosted video2ctx API is the programmatic route through the product. Use it to search and inspect YouTube data, retrieve normalized transcripts and related context, build research workflows, and manage monitors from server-side software.
