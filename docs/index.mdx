...
Choose one of three ways to use the product: work visually in the dashboard, equip an agent with published skills, or integrate the hosted API into your own software.
...
<CardGroup cols={3}>
  ...
  <Card title="Build with Agents" icon="robot" href="/agents">
    Install skills for direct YouTube extraction, visual inspection, hosted API access, and recurring monitoring.
  </Card>
